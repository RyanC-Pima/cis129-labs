...
# Ryan Calles
# CIS 129
# Asks for total number of hot dogs that will be consumed during a cookout, calculates amount of hot dog and hot dog bun packages needed, and returns expected left overs
...
def main():
    ...
    # Local Variables
    dogsLeft = int # Left over hot dogs
    bunsLeft = int # Left over hot dog buns
    minDogs = int # Minimum packages of hot dogs
    minBuns = int # Minimum packages of hot dog buns
